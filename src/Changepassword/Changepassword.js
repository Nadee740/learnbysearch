...
if(confirm_password==new_password)
{
    const user_data = {
          ...
          const {message:messagee} =await SendPost(`${window.name}change-password`, user_data)
        ...
        <div className="container-profile-col2 container-profile-col1">
          ...
          <input
           ...
           <input
            ...
            /><br></br>
                  <label htmlFor="confirmpassword">{confrmpasserr && confrmpasserr}</label>
